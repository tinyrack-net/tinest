...
void main() {
  testWidgets(
    ...
    (tester) async {
      ...
      const document = PluginUiDocumentDto(
        ...
        root: <String, dynamic>{
          ...
          'children': <Map<String, dynamic>>[
            ...
            <String, dynamic>{'type': 'markdown', 'text': '**Markdown text**'},
            <String, dynamic>{
              'type': 'code',
              'code': 'print("hello")',
              'language': 'lua',
            },
            <String, dynamic>{'type': 'diff', 'code': '- old\n+ new'},
            <String, dynamic>{
              'type': 'alert',
              'title': 'Attention',
      ...
      expect(
        actions.single.data,
        containsPair('values', <String, dynamic>{
          'query': 'initial',
          'enabled': true,
          'mode': 'safe',
        }),
  ...
  testWidgets('falls back to a generic disclosure for an invalid document', (
    tester,
  ) async {
    const document = PluginUiDocumentDto(
      id: 'invalid',
  ...
  testWidgets('a tree nests its own items and the host owns the indentation', (
    tester,
  ) async {
  ...
  testWidgets('a composer drawer is framed by the host, not by the document', (
    tester,
  ) async {
  ...
  testWidgets('uses the native keyboard action path', (tester) async {
    const document = PluginUiDocumentDto(
      id: 'keyboard',
